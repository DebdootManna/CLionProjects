//This program is written by Debdoot Manna The Great
...
protected:
    ...
    void getdata()
    {
        ...
        if(id<1000 || id>9999)
        {
            cout<<endl<<"Please enter a 4 digit employee id"<<endl;
            exit(0);
        }
...
int main()
{
    ...
    cout<<endl<<"WARNING : YOU MUST ENTER UNIQUE EMPLOYEE IDENTIFICATIONS FOR EACH EMPLOYEE REGARDLESS OF THEIR DIVISION"<<endl;
...
//OUTPUT
    ...
    if(flag_output==false)
    {
        for(int i=0;i<non_teachers;i++)
        {
            ...
            if(i==(non_teachers-1))
            {
                cout<<"Employee ID:"<<*employee_id<<" does not exist on database"<<endl<<"Please enter correct value"<<endl;
                goto output;
            }
        }
    }
